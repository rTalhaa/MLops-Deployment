...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{../Images_ForGPT/model_1_runs.PNG}
    \caption{MLflow run comparison captured from the project artifacts.}
    \label{fig:mlflow-runs}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{../Images_ForGPT/Model_1_Test.PNG}
    \caption{Model evaluation screenshot captured from the project artifacts.}
